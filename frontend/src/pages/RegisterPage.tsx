...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try { await register(name, email, password); navigate('/login?registered=1'); } catch (err: any) { setError(err.response?.data?.message || err.message); }
  };
                ...
                <Form.Group className="mb-3">
                  ...
                  <InputGroup>
                    ...
                    <Button
                      ...
                      aria-label={showConfirm ? 'Confirm password visible. Click to hide confirm password' : 'Confirm password hidden. Click to show confirm password'}
                    >
