        ...
        <div className="footerCmp">
            <footer>
                ...
                <div className="footerGetInTouch">
                    <h1>Get in touch</h1>
                    <ul>
                        <p>Any questions? Let us know 3200 Ocean drive TAMUCC or call us on (+1)2345678923 </p>
                ...
                <div className="paragraphFooter"><p>Copyright ©2021 All rights reserved | This template is made By <strong>Bits By Bits</strong></p>
                <Link to = '' >Madhu</Link>
                <Link to = ''  >Ranjith</Link>
                <Link to = ''  >Pallavi</Link>
                <Link to = ''  >Deepthi</Link>
                </div>
