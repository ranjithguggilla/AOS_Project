...
const Checkout = ({history}) => {
    ...
    const [country, setCountry] = useState(shippingAddress.country || 'Maroc')
            ...
            <div className="limit-check">
                ...
                <div className="info-check">
                    ...
                    <div className="billing-check">
                        ...
                        <label htmlFor="address" className="this-label">Address</label><br />
                        ...
                        <Stack spacing={3}>
                            ...
                            <Select variant="flushed" value={country} onChange = {(e) => setCountry(e.target.value)} >
                        ...
                        <div className="city-cp-check">
                            <div><label htmlFor="city" className="this-label">City</label>
                            <Input variant="flushed" required value={city} placeholder="Your City" onChange = {(e) => setCity(e.target.value)} id="city"/></div>
                            <div><label htmlFor="zip" className="this-label" >Zip</label>
                            <Input variant="flushed" required value={postalCode} placeholder="Your Zip" id="zip" onChange = {(e) => setPostalCode(e.target.value)}/></div>
                        </div>
                    </div>
                    ...
                    <div className="payment-check">
                        ...
                        <input onChange = {(e)=> {setcarddetails(true) ; setPayment('card')}} checked = {carddetails}  type="radio" name="payment" id="card"/><label htmlFor="card" className="this-label">Credit Card</label>
                        ...
                        <div><label htmlFor="name-card" className="this-label">Name on Card</label><br />
                        <Input variant="flushed" id="name-card" placeholder="Souhail Bourhjoul"/></div>
                        <div><label htmlFor="number-card" className="this-label">Credit card number</label><br />
                        <Input variant="flushed" id="number-card"  placeholder="3333-1111-8888-2222"/></div>
                        <div><label htmlFor="expir-mt-card" className="this-label">Exp Month</label><br />
                        <Input variant="flushed" id="expir-mt-card"  placeholder="January"/></div>
                        <div className="exp-ye-cvv-check">
                            <div><label htmlFor="exp-year" className="this-label">Exp Year</label>
                            <Input variant="flushed"  placeholder="2023" id="exp-year"/></div>
                            <div><label htmlFor="cvv-check" className="this-label">Cvv</label>
                            <Input variant="flushed"  placeholder="512" id="cvv-check"/></div>
                        </div>
                        </div>

                        <input onChange = {(e)=> {setcarddetails(false) ; setPayment('paypal')}} type="radio" name="payment" id="paypal"/><label htmlFor="paypal" className="this-label"> Paypal</label>
