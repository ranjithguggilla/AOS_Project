...
const Productpage = ({history,match}) => {
  ...
  const productNumReviews = typeof product?.numReviews === 'number' ? product.numReviews : 0
    ...
    return (
     ...
     <div className = "card-wrapper">
      <div className = "card">
        ...
        <div className = "img-display">
          ...
          <div className = "img-select">
            <div className = "img-item">
              <a href = "#" data-id = "1">
                <Image  objectFit="cover" boxSize = '200px' src = {productImages[0]} alt = "shoe image"/>
            ...
            <div className = "img-item">
              <a href = "#" data-id = "2">
                <Image  objectFit="cover" boxSize = '200px' src = {productImages[1]} alt = "shoe image"/>

              </a>
            </div>
            <div className = "img-item">
              <a href = "#" data-id = "3">
                <Image  objectFit="cover"  boxSize = '200px' src = {productImages[2]} alt = "shoe image"/>
        ...
        <div className = "product-content">
          ...
          <Link to = '/shop' className = "product-link">visit our store</Link>
              <Rating
              value={productRating}
              text={`${productNumReviews} reviews`}
              />
          ...
          <div className = "product-detail">
           ...
           <ul>
            ...
            <ul>
              ...
              <li>Category: <span>{productCategory.map(cg =>' | ' + cg + ' | ')}</span></li>
      ...
      <div className ='REVIEWS'>
        <h1>Reviews :</h1>
        {productReviews.length === 0 && <h2>NO REVIEWS</h2>}
        <div>
          {productReviews.map(review =>(
            <div key={review._id || review.createdAt} className='review'>
              <h4>{review.name}</h4>
